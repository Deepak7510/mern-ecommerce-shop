            ...
            <Card className='flex flex-col p-2'>
                <div className='flex flex-col gap-2'>
                    {cartItems && cartItems.items && cartItems.items.length > 0 ? cartItems.items.map(Item => {
                        ...
                        <Link className=' text-blue-600 underline' to={'/shop/listing'}>Go to the listing page</Link>
                    </div>
                    }
                </div>

                <div className='w-full'>
                    {cartItems && cartItems?.items?.length > 0 ? <><Card className="mt-3 p-3 space-y-1">
                        ...
                        <Card className='p-3 mt-2 space-y-2'>
                            ...
                            <RadioGroup className='flex' onValueChange={value => {
                        ...
                        <div> <Button onClick={() => { handleOrder() }} className='w-full mt-2'>Continue</Button></div></> : null}
                </div>
            </Card>
        </div>
    </div>
