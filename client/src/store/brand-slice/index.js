...
export const addBrand = createAsyncThunk("/brand/add", async (formData) => {
  try {
    const response = await axios.post(
      `${import.meta.env.VITE_BACKEND_URI}/api/admin/brand/add`,
      formData,
      {
  ...
  async ({ formData, id }) => {
    try {
      const response = await axios.put(
        `${import.meta.env.VITE_BACKEND_URI}/api/admin/brand/update/${id}`,
        formData,
        {
          withCredentials: true,
        }
...
export const deleteBrand = createAsyncThunk("/brand/delete", async (id) => {
  try {
    const response = await axios.delete(
      `${import.meta.env.VITE_BACKEND_URI}/api/admin/brand/delete/${id}`,
      {},
      {
        withCredentials: true,
      }
...
export const fetchAllBrand = createAsyncThunk("/brand/list", async () => {
  try {
    const response = await axios.get(
      `${import.meta.env.VITE_BACKEND_URI}/api/admin/brand/list`,
      {
        withCredentials: true,
      }
    );
