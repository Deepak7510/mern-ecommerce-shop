  ...
  async (orderId) => {
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_BACKEND_URI}/api/admin/order/details/${orderId}`
      );
...
export const fetchAllOrder = createAsyncThunk(
  ...
  async () => {
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_BACKEND_URI}/api/admin/order/list`
      );
      return response?.data;
    } catch (error) {
  ...
  async ({ orderId, formData }) => {
    try {
      ...
      const response = await axios.put(
        `${import.meta.env.VITE_BACKEND_URI}/api/admin/order/update/${orderId}`,
        formData
      );
      return response?.data;
    } catch (error) {
